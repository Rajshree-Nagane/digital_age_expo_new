...
export const speakerRegistrationSchema = z.object({
  ...
  why_exhibit: z.enum(["yes", "no", "maybe"]).optional(),
  ...
  confirm_consent: z.boolean().refine((val) => val === true, {
    message: "You must confirm that you have read and understood the consent requirement.",
  }),
});

export type SpeakerRegistrationInput = z.infer<typeof speakerRegistrationSchema>;
