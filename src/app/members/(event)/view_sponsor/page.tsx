...
import { getSponsorsAdmin } from "@/lib/services/eventSponsorAdmin";
    ...
    return (
      <div className="space-y-8">
        <div className="space-y-2">
          ...
          <h1 className="text-4xl font-black uppercase tracking-tight text-white">Sponsor Directory</h1>
        </div>
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        ...
        <h1 className="text-4xl font-black uppercase tracking-tight text-white">Sponsor Directory</h1>
        <p className="text-zinc-400 font-medium max-w-2xl">Manage and monitor all partners and sponsors backing this event.</p>
      </div>

      <div>
        <SponsorsAdminManager sponsors={sponsors} />
      </div>
    </div>
  );
}
