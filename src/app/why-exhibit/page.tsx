  ...
  return (
    <div className="bg-slate-950 text-white min-h-screen pb-20">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(var(--color-slate-900-rgb), 0.9), rgba(var(--color-violet-900-rgb), 0.85)), url('https://digitalageexpo.com/files/listing_pages/818073-dae_index_top_banner.jpg')`,
        }}
      >
